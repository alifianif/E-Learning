        ...
        <div id="wrapper">
            ...
            <div class="sidebar-collapse menu-scroll">
                <ul id="side-menu" class="nav">
                    ...
                    <li class="active"><a href="<?php echo base_url().'Welcome/materi'?>"><i class="fa fa-database fa-fw">
            ...
            $kd_materi=$baris->kd_materi;
            $nama_materi=$baris->nama_materi;
            $nama_matkul=$baris->nama_matkul;
            $kelas=$baris->kelas; 
            $isi_materi=$baris->isi_materi; 
            ...
            ?>
                ...
                <form action="<?php echo base_url().'Dashboard/simpaneditMateriDosen'?>" method="post">
                <table style="width: 500px">
                    <tr>
                        <td> <label class="col-sm-3 control-label">Kode Materi</label></td>
                        <td>&nbsp;&nbsp;</td>
                        <td> <input disabled type="text" name="judul" class="form-control" value ="<?php echo $kd_materi;?>" required placeholder="kode materi"></td>
                    ...
                    <tr>
                        ...
                        <td>&nbsp;&nbsp;</td>
                        <td> <input type="text" name="judul" value="<?php echo $nama_materi;?>" class="form-control" required placeholder="judul materi"></td>
                    ...
                    <tr>
                        ...
                        <td> 
                            ...
                            <option value='<?php echo $nama_matkul;?>'><?php echo $nama_matkul;?></option>
                            <?php 
                            foreach ($list_matkul as $matkuls) {
                            echo "<option value='$matkuls[kd_matkul]'>$matkuls[nama_matkul]</option>";
                            }
                            ?>
                            </select>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>&nbsp;&nbsp;</td>
                        <td> <input type="text" name="kelas" class="form-control" required placeholder="kelas" value="<?php echo $kelas;?>"></td>
...
<input id="input-ficons-1" name="inputficons1" multiple type="file" class="file-loading" value="<?php echo $isi_materi;?>">
<script>
