                    ...
                    <div id="tab-general">
                        <div class="row mbl">
                            <div class="col-lg-12">
                             ...
                             <div class="page-content">
                                <h2><p>Tambah Materi Mata Kuliah </p></h2>
                                <div class="text-left mbl" style=" width: 300px;" >                                      
                                <form method="post" action="<?php echo base_url().'Dashboard/insertMateri' ?>">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="inputIDKepalaArea">Kode Mata Kuliah</label>
                                        <div>
                                            <input type="text" class="form-control" name="kdmatkul"  placeholder="Kode Mata Kuliah">
                                             
                                        </div>
                                    </div>
                                   <div class="form-group">
                                        <label for="inputNamaKepalaArea">Kode Materi</label>
                                        <div>
                                            <input type="text" class="form-control" name="kdmateri" placeholder="Kode Materi">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputAreaKepalaArea">Nama Materi</label>
                                        <div>
                                            <input type="text" class="form-control" name="namamateri" placeholder="Nama Materi">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputContact">Upload File</label>
                                        <div>
                                            <input id="input-folder-1" type="file" class="file-loading" name="isimateri" webkitdirectory>
<script>
    ...
    $("#input-folder-1").fileinput({
        browseLabel: 'Select Folder...'
                                    ...
                                    <!-- <div class="form-group">
                                        ...
                                        <div>
                                            <div class="form-group">
                                                <select required name="ddlGolongan" id="ddlGolongan" class="form-control select2" style="width: 100%;">
                                    ...
                                    <div  class="box-footer pull-right">
                                        <a href="#"><button type="reset" class="btn btn-info">Batal</button></a>
                                        <a href="<?php echo base_url().'Dashboard/insertMateri' ?>">
                                        <button id="myBtn" type="button" class="btn btn-info" data-toggle="modal">Simpan</button></a>
                                    </div>
                                </div>
